    ...
    return (
        <li className="flex  items-center gap-3" onClick={() => setBrand(name)}>
            <Checkbox
                checked={is_checked}
                color="#000"
                className="h-5 w-5 border-default-500 data-[state=checked]:bg-primary-500 rounded-[4px] data-[state=checked]:border-primary-600 cursor-pointer transition-transform active:scale-95 !text-white" />
...
export default function BrandFilter({
    ...
    return (
        <div className="border-b pb-4">
            ...
            <ul className="mt-6 flex md:flex-col  gap-4">
                {
